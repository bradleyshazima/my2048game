// lib/game_screen_6x6.dart
import 'package:flutter/material.dart';
import 'dart:math'; // For random number generation

// GameScreen6x6 is a StatefulWidget to manage the 6x6 game board and score.
...
// The State class for GameScreen6x6. This is where the mutable state and game logic reside.
class _GameScreen6x6State extends State<GameScreen6x6> {
  static const int boardSize =
      6; // The 6x6 grid for 2048, hardcoded for this screen
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('6x6'), // Specific title for 6x6
        leading: IconButton(
