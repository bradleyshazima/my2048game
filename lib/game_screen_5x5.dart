// lib/game_screen_5x5.dart
import 'package:flutter/material.dart';
import 'dart:math'; // For random number generation

// GameScreen5x5 is a StatefulWidget to manage the 5x5 game board and score.
...
// The State class for GameScreen5x5. This is where the mutable state and game logic reside.
class _GameScreen5x5State extends State<GameScreen5x5> {
  static const int boardSize =
      5; // The 5x5 grid for 2048, hardcoded for this screen
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('5x5'), // Specific title for 5x5
        leading: IconButton(
