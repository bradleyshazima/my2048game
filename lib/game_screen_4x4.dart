// lib/game_screen_4x4.dart
import 'package:flutter/material.dart';
import 'dart:math'; // For random number generation

// GameScreen4x4 is a StatefulWidget to manage the 4x4 game board and score.
class GameScreen4x4 extends StatefulWidget {
  // Renamed class from GameScreen to GameScreen4x4
...
// The State class for GameScreen4x4. This is where the mutable state and game logic reside.
class _GameScreen4x4State extends State<GameScreen4x4> {
  static const int boardSize =
      4; // The 4x4 grid for 2048, hardcoded for this screen
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('4x4'), // Specific title for 4x4 game
        leading: IconButton(
